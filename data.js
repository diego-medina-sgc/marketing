...
const BIRTHDAYS = [
  { d: 1,  m: 12, name: 'Tardieu, Magalí',       dept: 'P',  campus: 'q' },
  { d: 1,  m: 12, name: 'Jofre, Fernanda',       dept: 'M',  campus: 'one' },
  { d: 4,  m: 12, name: 'Pereira, Martín',       dept: 'S',  campus: 'q' },
  { d: 8,  m: 12, name: 'Onsari, Agustín',       dept: 'P',  campus: 'n' },
  { d: 9,  m: 12, name: 'Del Coco, Valeria',     dept: 'S',  campus: 'q' },
  { d: 10, m: 12, name: 'Pierro, Elizabeth',     dept: 'P',  campus: 'q' },
  { d: 11, m: 12, name: 'De Elia, Valeria',      dept: 'S',  campus: 'n' },
  { d: 14, m: 12, name: 'Carrizo, Viviana',      dept: 'M',  campus: 'one' },
  { d: 20, m: 12, name: 'Silvera, Jorge',        dept: 'M',  campus: 'one' },
  { d: 21, m: 12, name: 'Baratti, Florencia',    dept: 'Bd', campus: 'q' },
  { d: 21, m: 12, name: 'Carpaneto, Beatriz',    dept: 'P',  campus: 'q' },
  { d: 24, m: 12, name: 'López, M. Victoria',    dept: 'S',  campus: 'n' },
  { d: 25, m: 12, name: 'Rush, Margarita',       dept: 'P',  campus: 'q' },
  { d: 25, m: 12, name: 'Díaz, Daniela',         dept: 'S',  campus: 'q' },
  { d: 26, m: 12, name: 'Mattioli, M. Luz',      dept: 'S',  campus: 'n' },
  { d: 29, m: 12, name: 'Franco, Mariano',       dept: 'M',  campus: 'one' },
  { d: 30, m: 12, name: 'Williams, Hernán',      dept: 'EF', campus: 'q' },
  { d: 31, m: 12, name: 'Fedele, M. Eugenia',    dept: 'P',  campus: 'q' },
  { d: 31, m: 12, name: 'Gembarowski, Carolina', dept: 'P',  campus: 'n' }
];
