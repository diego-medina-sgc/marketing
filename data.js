...
const BIRTHDAYS = [
  { d: 1,  m: 6, name: 'Antón, Laura',           dept: '', campus: 'q' },
  { d: 1,  m: 6, name: 'Pigun, Brenda',          dept: '', campus: 'q' },
  { d: 1,  m: 6, name: 'Grisolia, Samantha',     dept: '', campus: 'q' },
  { d: 2,  m: 6, name: 'Suarez, Monica',         dept: '', campus: 'one' },
  { d: 2,  m: 6, name: 'Barreto, Florencia',     dept: '', campus: 'n' },
  { d: 3,  m: 6, name: 'De Gregorio, Mariela',   dept: '', campus: 'q' },
  { d: 4,  m: 6, name: 'Santana, Verónica',      dept: '', campus: 'n' },
  { d: 4,  m: 6, name: 'Aleso, Facundo',         dept: '', campus: 'n' },
  { d: 4,  m: 6, name: 'Souza, Mariela',         dept: '', campus: 'q' },
  { d: 5,  m: 6, name: 'Suarez, Gonzalo',        dept: '', campus: 'q' },
  { d: 7,  m: 6, name: 'Lobo, Francisco',        dept: '', campus: 'one' },
  { d: 7,  m: 6, name: 'Cebey, Diego',           dept: '', campus: 'q' },
  { d: 9,  m: 6, name: 'Milana, Victor',         dept: '', campus: 'q' },
  { d: 9,  m: 6, name: 'Filipe Martins, Eloisa', dept: '', campus: 'n' },
  { d: 10, m: 6, name: 'Doxat, Connie',          dept: '', campus: 'one' },
  { d: 11, m: 6, name: 'Silva, Paula',           dept: '', campus: 'n' },
  { d: 12, m: 6, name: 'Casas, Fabián',          dept: '', campus: 'n' },
  { d: 13, m: 6, name: 'Rojo, José',             dept: '', campus: 'n' },
  { d: 14, m: 6, name: 'Lettieri, Jesica',       dept: '', campus: 'n' },
  { d: 15, m: 6, name: 'Gibson, Flora',          dept: '', campus: 'q' },
  { d: 15, m: 6, name: 'Mazzini, Lautaro',       dept: '', campus: 'n' },
  { d: 15, m: 6, name: 'Rossini, Lucila',        dept: '', campus: 'n' },
  { d: 15, m: 6, name: 'Alberti, Victoria',      dept: '', campus: 'n' },
  { d: 16, m: 6, name: 'Estrada, Eva',           dept: '', campus: 'one' },
  { d: 16, m: 6, name: 'Welschbillig, Dora',     dept: '', campus: 'q' },
  { d: 18, m: 6, name: 'Molachino, M. Paz',      dept: '', campus: 'n' },
  { d: 20, m: 6, name: 'Díaz, Gerardo',          dept: '', campus: 'one' },
  { d: 21, m: 6, name: 'Serrano, Milton',        dept: '', campus: 'one' },
  { d: 23, m: 6, name: 'Raffaelli, Candela',     dept: '', campus: 'n' },
  { d: 23, m: 6, name: 'Godoy, Iván',            dept: '', campus: 'q' },
  { d: 24, m: 6, name: 'Taboada, Juan Pablo',    dept: '', campus: 'q' },
  { d: 24, m: 6, name: 'Whitney, Lynn',          dept: '', campus: 'q' },
  { d: 24, m: 6, name: 'Rojas, Osvaldo',         dept: '', campus: 'one' },
  { d: 24, m: 6, name: 'Sciuso, Lucía',          dept: '', campus: 'n' },
  { d: 25, m: 6, name: 'Balmaceda, Romina',      dept: '', campus: 'n' },
  { d: 25, m: 6, name: 'Tristan, Jacob',         dept: '', campus: 'n' },
  { d: 25, m: 6, name: 'Rojas, Juan',            dept: '', campus: 'one' },
  { d: 25, m: 6, name: 'Molachino, Romina',      dept: '', campus: 'q' },
  { d: 28, m: 6, name: 'Cardoso, Viviana',       dept: '', campus: 'one' },
  { d: 29, m: 6, name: 'Belloso, M. Sol',        dept: '', campus: 'n' },
  { d: 29, m: 6, name: 'Tangorra, Agustín',      dept: '', campus: 'q' },
  { d: 30, m: 6, name: 'Ciriani, Yanina',        dept: '', campus: 'n' }
];
