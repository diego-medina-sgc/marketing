...
var SYSTEM_PROMPT =
  ...
  "AVOID PROMOTIONAL LANGUAGE: Never use: 'talented students', 'outstanding students', 'vibrant celebration', 'exciting occasion', 'exciting opportunity', 'thrilling opportunity', 'memorable moments', 'house pride', 'full of excitement', 'enthusiasm and pride for the Houses'. Prefer neutral warm language: 'students', 'performance', 'production', 'opportunity to celebrate together', 'House spirit', 'community', 'teamwork', 'learning experiences', 'a day together as a community'. Maintain warmth without exaggerated enthusiasm or brochure-style wording.\n" +
